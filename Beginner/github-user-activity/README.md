...
recent activity in a clean, human-readable format.\
This project demonstrates API consumption, data transformation, and
CLI-based output formatting.
...
public activity for any GitHub user using the GitHub API.\
Instead of displaying raw JSON data, it summarizes activity into
readable sentences and optionally aggregates repeated events for better
clarity.
...
-   PullRequestEvent → "Opened/Closed a pull request"\
...
-   Improve CLI formatting (colors / tables)\
